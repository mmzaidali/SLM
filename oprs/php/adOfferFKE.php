...
mysql_select_db($database_connect, $connect);
$query_fke = "SELECT * FROM profile WHERE department = 'fke'";
$fke = mysql_query($query_fke, $connect) or die(mysql_error());
$row_fke = mysql_fetch_assoc($fke);
$totalRows_fke = mysql_num_rows($fke);
?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="row">
                    ...
                    <nav class="navbar navbar-default">
                        <div class="container-fluid">
                            <div class="navbar-header">
                                <a class="navbar-brand">Fakulti Kejuruteraan Elektrik</a>
                            </div>
                        </div>
                    </nav>
                </div>
                ...
                <div class="col-md-12">
                    <ul class="nav nav-pills nav-justified">
                        ...
                        <li><a href="../php/adOfferFPTT.php">FPTT</a></li>
                        <li class="active"><a href="../php/adOfferFKE.php">FKE</a></li>
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped" data-toggle="table">
                            ...
                            <?php do { ?>
                              <tr>
                                <td><?php echo $row_fke['id_No']; ?></td>
                                <td><?php echo $row_fke['name']; ?></td>
                                <td><?php echo $row_fke['department']; ?></td>
                                <td><?php echo $row_fke['position']; ?></td>
                                <td>
                                  <form action="<?php echo $editFormAction; ?>" method="POST" name="form">
                                    <input value="<?php echo $row_fke['name']; ?>" type="hidden" name="fname">
                                    <input value="<?php echo $row_fke['id_No']; ?>" type="hidden" name="staff">
                                    <input value="<?php echo $row_fke['department']; ?>" type="hidden" name="depart">
                                    <input value="<?php echo $row_fke['position']; ?>" type="hidden" name="poss">
                                    <button type="submit" class="btn btn-default">Select</button>
                                    <input type="hidden" name="MM_insert" value="form">
                                  </form>
                                    <?php } while ($row_fke = mysql_fetch_assoc($fke)); ?></td>
                              </tr>
                          </tbody>
                          </table>
