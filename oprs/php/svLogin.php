...
if (isset($_POST['svid'])) {
  $loginUsername=$_POST['svid'];
  $password=$_POST['pass'];
  $MM_fldUserAuthorization = "";
  $MM_redirectLoginSuccess = "svpage.php";
  $MM_redirectLoginFailed = "svLogin.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_connect, $connect);
  
  $LoginRS__query=sprintf("SELECT username, password FROM svlogin WHERE username=%s AND password=%s",
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-md-offset-4">
		          <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" role="form">
			         <h2>Please Sign In <small>Supervisor Login</small></h2>
			     
                      <hr class="colorgraph">
                    <div class="input-group">
                        <div class="input-group-addon"><i class="glyphicon glyphicon-user"></i></div>
				        <input type="text" name="svid" id="svid" class="form-control input-lg" placeholder="Supervisor ID" required>
			         </div>
