...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="adOfferFTMK.php";
  $loginUsername = $_POST['staff'];
  $LoginRS__query = sprintf("SELECT staffNo FROM offers WHERE staffNo=%s", GetSQLValueString($loginUsername, "text"));
...
mysql_select_db($database_connect, $connect);
$query_fakulti = "SELECT * FROM profile WHERE department = 'ftmk' ORDER BY idprofile DESC";
...
$query_fakulti = "SELECT * FROM profile WHERE department = 'ftmk'";
$fakulti = mysql_query($query_fakulti, $connect) or die(mysql_error());
$row_fakulti = mysql_fetch_assoc($fakulti);
$totalRows_fakulti = mysql_num_rows($fakulti);
?>
            ...
            <div class="row">
                    ...
                    <nav class="navbar navbar-default">
                        <div class="container-fluid">
                            <div class="navbar-header">
                                <a class="navbar-brand">Fakulti Teknologi Maklumat dan Komunikasi</a>
                            </div>
                        </div>
                    </nav>
                </div>
                ...
                <div class="col-md-12">
                    <ul class="nav nav-pills nav-justified">
                        <li class="active"><a href="../php/adOfferFTMK.php">FTMK</a></li>
