...
if (isset($_POST['username'])) {
  ...
  $LoginRS__query=sprintf("SELECT username, password FROM adminuser WHERE username=%s AND password=%s",
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-md-offset-4">
		          <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" role="form">
                      <img src="../img/admin.png" width="360" alt="">
			         <!--<h2>Administrator<small> Login</small></h2>-->
			     
                      <hr class="colorgraph">
                    <div class="input-group">
                        <div class="input-group-addon"><i class="glyphicon glyphicon-user"></i></div>
				        <input type="text" name="username" id="username" class="form-control input-lg" placeholder="Admin ID" required>
			         </div>
