...
if (isset($_POST['staffid'])) {
  ...
  $LoginRS__query=sprintf("SELECT id_No, password FROM profile WHERE id_No=%s AND password=%s",
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-md-offset-4">
		          <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" role="form">
			         <h2>Please Sign In <small>Staff Login</small></h2>
			     
                      <hr class="colorgraph">
                    <div class="input-group">
                        <div class="input-group-addon"><i class="glyphicon glyphicon-user"></i></div>
				        <input type="text" name="staffid" id="staffid" class="form-control input-lg" placeholder="Staff ID" required>
			         </div>
