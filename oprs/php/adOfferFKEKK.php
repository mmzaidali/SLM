...
mysql_select_db($database_connect, $connect);
$query_fakulti = "SELECT name, id_No, department, `position` FROM profile WHERE department = 'fkekk'";
            ...
            <div class="row">
                    ...
                    <nav class="navbar navbar-default">
                        <div class="container-fluid">
                            <div class="navbar-header">
                                <a class="navbar-brand">Fakulti Kejuruteraan Elektrik dan Elektronik</a>
                            </div>
                        </div>
                    </nav>
                </div>
                ...
                <div class="col-md-12">
                    <ul class="nav nav-pills nav-justified">
                        ...
                        <li class="active"><a href="../php/adOfferFKEKK.php">FKEKK</a></li>
