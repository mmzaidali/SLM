...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "pass")) {
  $insertSQL = sprintf("INSERT INTO working (workName, workStaff) VALUES (%s, %s)",
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "working")) {
  $updateSQL = sprintf("UPDATE working SET `position`=%s, d_start=%s, d_end=%s, salary=%s, reason_leave=%s, company=%s, address=%s, postcode=%s, city=%s, region=%s, workName=%s WHERE workStaff=%s",
...
mysql_select_db($database_connect, $connect);
$query_working = "SELECT * FROM working ORDER BY idworking DESC";
$working = mysql_query($query_working, $connect) or die(mysql_error());
$row_working = mysql_fetch_assoc($working);
$totalRows_working = mysql_num_rows($working);
...
{
  $colname_prowork = $_POST['carian'];
  $query_prowork = "SELECT * FROM profile WHERE name LIKE '%".$colname_prowork."%' OR id_No LIKE '%".$colname_prowork."%' OR department LIKE '%".$colname_prowork."%' ";
}
else
{
	$query_prowork = "SELECT * FROM profile";
}

$prowork = mysql_query($query_prowork, $connect) or die(mysql_error());
$row_prowork = mysql_fetch_assoc($prowork);
$totalRows_prowork = mysql_num_rows($prowork);
    ...
    <div class="row profile">
		...
		<div class="col-md-9">
            <div class="row">
                    ...
                    <nav class="navbar navbar-default">
                        <div class="container-fluid">
                            <div class="navbar-header">
                                <a class="navbar-brand">Working History</a>
                            </div>
                        </div>
                    </nav>
                </div>
                ...
                <form method="POST" action="<?php echo $editFormAction; ?>" name="working">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-md-4">Name</label><br>
                                <input value="<?php echo $row_working['workName']; ?>" type="text" class="form-control" name="fname" placeholder="Fullname" required>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-4">Salary</label><br>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-md-4">Staff ID</label><br>
                                <input value="<?php echo $row_working['workStaff']; ?>" type="text" class="form-control" name="staffid" placeholder="Staff ID" required>
                        </div>

                        <div class="form-group">
                            <label class="col-md-4">Company</label><br>
                                <input type="text" class="form-control" name="company" placeholder="Company Name" required>
                        </div>

                        <div class="form-group">
                            <label class="col-md-4">Address</label><br>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="col-md-4">Postcode</label><br>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="col-md-4">City</label><br>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="col-md-4">Region</label><br>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="col-md-4">Reason Leave</label><br>
                                <textarea class="form-control" row="50" name="reason" placeholder="Type Here ..." required></textarea>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="MM_update" value="working">
                </form>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <table class="table table-striped" data-toggle="table">
            ...
            <?php do { ?>
            <tr>
              <td><?php echo $row_prowork['idprofile']; ?></td>
              <td><?php echo $row_prowork['name']; ?></td>
              <td><?php echo $row_prowork['position']; ?></td>
              <td><?php echo $row_prowork['id_No']; ?></td>
              <td><?php echo $row_prowork['department']; ?></td>
              <td><form action="<?php echo $editFormAction; ?>" method="POST" name="pass">
              <input value="<?php echo $row_prowork['name']; ?>" type="hidden" name="name">
              <input value="<?php echo $row_prowork['id_No']; ?>" type="hidden" name="staffno">
              <button type="submit" class="btn btn-default">Select</button>
              <input type="hidden" name="MM_insert" value="pass">
              </form></td>
            </tr>
            <?php } while ($row_prowork = mysql_fetch_assoc($prowork)) ?>
          </table>
      </div>
