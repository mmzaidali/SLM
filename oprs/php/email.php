        ...
        <div class="col-lg-9">
                ...
                <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="email" class="form-control input-sm" id="form" placeholder="you@example.com">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="email" class="form-control input-sm" id="txtTo" placeholder="you@example.com">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control input-sm" id="txtTo" placeholder="Subject">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <textarea class="form-control input-sm" row="10" id="message" placeholder="Type here"></textarea>
                            </div>
                        </div>
