...
mysql_select_db($database_connect, $connect);
$query_fakulti = "SELECT name, id_No, department, `position` FROM profile WHERE department = 'fkp'";
...
$query_fakulti = "SELECT name, id_No, department, `position` FROM profile WHERE department = 'ftk'";
$fakulti = mysql_query($query_fakulti, $connect) or die(mysql_error());
$row_fakulti = mysql_fetch_assoc($fakulti);
$totalRows_fakulti = mysql_num_rows($fakulti);
?>
            ...
            <div class="row">
                    ...
                    <nav class="navbar navbar-default">
                        <div class="container-fluid">
                            <div class="navbar-header">
                                <a class="navbar-brand">Fakulti Teknologi Kejuruteraan</a>
                            </div>
                        </div>
                    </nav>
                </div>
                ...
                <div class="col-md-12">
                    <ul class="nav nav-pills nav-justified">
                        ...
                        <li class="active"><a href="../php/adOfferFTK.php">FTK</a></li>
                    </ul><br>
                </div>
                    ...
                    <table class="table table-striped" data-toggle="table">
                        ...
                        <?php do { ?>
                          <tr>
                            ...
                            <td><form method="POST" action="<?php echo $editFormAction; ?>" name="form">
